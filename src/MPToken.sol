...
contract MPToken is ERC20 {
    ...
    function stakeToDeal(address deal, uint256 amount) public {
    ...
    function burn(uint256 amount) external onlyDACEntity {
        _burn(msg.sender, amount);
    }

    function burnFrom(address from, uint256 amount) external onlyDACEntity {
        _burn(from, amount);
    }
